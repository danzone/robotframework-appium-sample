...
Start Appium Server
    ...
    Start Process  appium --address 127.0.0.1 --webdriveragent-port 8100 --driver-args '{"xcuitest": {"wdaLocalPort": 8100}}'
    ...     --default-capabilities '{"appium:useNewWDA": true, "appium:showXcodeLog" : true}' --log ${CURDIR}/appium.log
