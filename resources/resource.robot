...
Start Appium Server
    ...
    Start Process  appium --address 127.0.0.1 --webdriveragent-port 8100 --default-capabilities '{"useNewWDA": true, "usePrebuiltWDA" : true}' --log ${CURDIR}/appium.log  shell=True  alias=appiumserver
